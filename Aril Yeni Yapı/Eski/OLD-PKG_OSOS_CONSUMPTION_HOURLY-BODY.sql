...
-------------------------------------------------------------------------------
  ...
  --  Description    : Golden Gate üzerinden alınan datalar birleştiriliyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : Aril uygulamasının endeksleri alınıyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  BEGIN
    ...
    gv_dyn_task := '
      ...
      SELECT /*+PARALLEL(E,128) PARALLEL(D,32) PARALLEL(M,32) */ 
            ...
            1 APPLICATION_ID
        SELECT *
      FROM '||gv_ods_owner||'.'||v_src_table_01||' E 
      INNER JOIN '||gv_osos_adm_owner||'.'||v_src_table_02||' D ON (E.OWNERSERNO = D.SERNO) AND D.DEFINITIONTYPESERNO IN( 2,9,11)
      INNER JOIN '||gv_osos_adm_owner||'.'||v_src_table_03||' M ON (E.SENSORSERNO = M.SERNO) AND M.DEFINITIONTYPESERNO = 4
      LEFT JOIN '||gv_edw_owner||'.'||v_src_table_04||' M ON 
  ...
  --  Description    : Hayen uygulamasının endeksleri alınıyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : Luna uygulamasının endeksleri alınıyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  BEGIN
    ...
    gv_dyn_task := '
      ...
      (
          ...
          LEFT '||gv_osos_luna_owner||'.'||v_src_table_02||' OB2 ON (OB1.OBISOKUMAID = OB2.OBISOKUMAID)
          LEFT '||gv_osos_luna_owner||'.'||v_src_table_03||' OB3 ON (OB1.OBISOKUMAID = OB3.OBISOKUMAID)
  ...
  --  Description    : Uygulamalara ait olan endeks bilgileri birleştiriliyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : Endekslerin bir önceki değeleri bulunuyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : Endeksler üzerinden tüketim hesaplanıyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : Tablo üzerindeki Aril ve Luna partitionları siliniyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : Endeks tüketimleri ve endeks değerleri tabloya basılıyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
    v_table_name    varchar2(35) := 'F_MRR_DAILY_ENDEXES';
  ...
  --  Description    : K2 abone listesi alınıyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : K2 abonelerinin tüketimleri hesaplanıp tabloya basılıyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : Tarımsal tüketimler hesaplanıyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
    v_table_name    varchar2(35) := 'PRC_AGRICULTURAL_IRRIGATION';
    ----------------------------------------------------------------------------
  ...
  BEGIN
    ...
    FROM '||gv_edw_owner||'.'||v_src_table_02||' E
  ...
  --  Description    : Tarımsal tüketimi hesaplanan abone sayıları belirleniyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : YKP den alınan saatlik tüketim verileri günlük tüketime dönüştürülüyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : Hesaplanan günlük tüketim verileri aylık tüketime dönüştürülüyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  --  Description    : Tarımsal tüketim verileri crosstab e dönüştürülüyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
  ...
  BEGIN
    ...
    LEFT JOIN '||gv_ods_owner||'.'||v_src_table_03||' S ON (S.TESISAT_NO=E.SUBSCRIBER_ID)
    WHERE
    E.ENDEX_DATE >= TO_DATE(''20170101'',''YYYYMMDD'')
    AND  M.SECTOR_INFO = ''Tar�msal Sulama''
    AND CONSUMPTION_VALUE >0
  ...
  --  Description    : Aydınlatma tüketimleri hesaplanıp tabloya yazılıyor.
  --  [Modification History]
  ------------------------------------------------------------------------------
    ----------------------------------------------------------------------------
